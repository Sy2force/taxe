...
const navItems = [
  ...
  { path: '/answers',      icon: MessageSquare,label: 'Réponses',       step: '3', color: 'from-emerald-500 to-teal-500' },
  { path: '/verification', icon: ShieldCheck,  label: 'Vérification',  step: '4', color: 'from-amber-500 to-orange-500' },
  { path: '/final-check',  icon: FileCheck,    label: 'Final',         step: '5', color: 'from-rose-500 to-pink-500' },
];
